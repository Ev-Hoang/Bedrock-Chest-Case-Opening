...
public class CustomDropAnimationGui extends GuiScreen {
    ...
    public CustomDropAnimationGui(DungeonDropItem rewardItem) {
    	...
    	mc.func_147118_V().func_147682_a(PositionedSoundRecord.func_147674_a(audio, 1.0F));
   ...
   int getBoxColor(DropRarity rarity) {
    ...
    public void func_73866_w_() {
        ...
        if (mc.field_71460_t != null && mc.func_147110_a() != null) {
            try {
            	blurShader = new ShaderGroup(mc.func_110434_K(), mc.func_110442_L(), mc.func_147110_a(), new ResourceLocation("bedrockcaseopening", "shaders/post/blur.json"));
                blurShader.func_148026_a(mc.field_71443_c, mc.field_71440_d);
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void renderJudgementLine() {
        ...
        func_73734_a((int)(centerX - lineWidth/2),
