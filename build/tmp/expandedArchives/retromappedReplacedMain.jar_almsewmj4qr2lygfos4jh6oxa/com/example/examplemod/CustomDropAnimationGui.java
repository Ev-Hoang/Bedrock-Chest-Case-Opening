...
public class CustomDropAnimationGui extends GuiScreen {
    ...
    private ResourceLocation alphaFadeSidePNG = new ResourceLocation("examplemod", "textures/gui/fade_side.png");
    ...
    private void rewardRandomizer(DungeonDropItem rewardItem) {
    	...
    	if(rewardItem.getRarityIndex() < 3) {
    		checkRepeat.set(rewardItem.getRarityIndex(), true);       	
    	}
   ...
   int getBoxColor(DropRarity rarity) {
    ...
    private void updateLayout(ScaledResolution scaled) {
        ...
        System.out.println("[DEBUG] Resolution changed → MC.window" + mc.field_71443_c +
                " x " + mc.field_71440_d);
    }
    ...
    public void func_73866_w_() {
        super.func_73866_w_();
        if (mc.field_71460_t != null && mc.func_147110_a() != null) {
            try {
            	blurShader = new ShaderGroup(mc.func_110434_K(), mc.func_110442_L(), mc.func_147110_a(), new ResourceLocation("examplemod", "shaders/post/blur.json"));
                blurShader.func_148026_a(mc.field_71443_c, mc.field_71440_d);
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void setupStencilLayer1() {
        frameBufferLayer1.func_147604_a(0, 0, 0, 0);  
        frameBufferLayer1.enableStencil();
        frameBufferLayer1.func_147610_a(true);
    ...
    public void renderLayer1(float progress) {
        ...
        GlStateManager.func_179112_b(GL11.GL_ZERO, GL11.GL_ONE_MINUS_SRC_ALPHA);
        mc.func_110434_K().func_110577_a(alphaFadeSidePNG);
        Gui.func_146110_a(0, 0, 0, 0, 1920, 1080, screenWidth, screenHeight);
        ...
        frameBufferLayer1.func_178038_a(screenWidth, screenHeight, false);
        GlStateManager.func_179084_k();
        GlStateManager.func_179131_c(1f, 1f, 1f, 1f);
    }
    
    public void setupStencilLayer2() {
    	frameBufferLayer2.func_147604_a(0, 0, 0, 0);  
    	frameBufferLayer2.enableStencil();
    	frameBufferLayer2.func_147610_a(true);
    ...
    public void renderLayer2(float progress) {
        ...
        GlStateManager.func_179147_l();
        GlStateManager.func_179112_b(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
        frameBufferLayer2.func_178038_a(screenWidth, screenHeight, false);
        GlStateManager.func_179084_k();
        GlStateManager.func_179131_c(1f, 1f, 1f, 1f);
    }
    ...
    public void drawCarousel(float centerX, float centerY, float size) {
        for (int i = 0; i < carouselItems.size(); i++) {
            ...
            GlStateManager.func_179131_c(1f, 1f, 1f, 1f);
            func_73734_a((int) x, (int) y, (int) (x + itemBoxWidth * size), (int) (y + itemBoxHeight * size), 0x3F888888);
            
            GlStateManager.func_179131_c(1f, 1f, 1f, 1f);
            func_73734_a((int) x, (int) y1, (int) (x + itemBoxWidth * size), (int) y2, boxColor);
            
            GlStateManager.func_179147_l();
            GlStateManager.func_179112_b(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
            GlStateManager.func_179131_c(1f, 1f, 1f, 1f);
            func_73733_a((int)x, (int) (y2 -  itemBoxHeight * size) , (int)(x + itemBoxWidth * size), (int)y2, (boxColor & 0x00FFFFFF) | 0x00 << 24, (boxColor & 0x00FFFFFF) | 0xCC << 24);
            GlStateManager.func_179084_k();
            ...
            func_73734_a((int)(centerX - lineWidth/2), (int)(centerY - lineHeight/3 * 2.5), (int)(centerX + lineWidth), (int)(centerY + lineHeight), 0xFFFFA500);
        }
    }
    ...
    public void renderImage(int slot, float currentX, float currentY, float size) {
        ...
        if (image != null) {
        	...
        	func_152125_a((int)imageX, (int)imageY, 0, v, 16, 16, (int)imageSize, (int)imageSize, 16f, frameHeight * frameCount);
        }
    }
